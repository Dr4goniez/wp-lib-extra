...
var wikiLib = (function () {
    ...
    var ParsedTemplate = /** @class */ (function (_super) {
        ...
        function ParsedTemplate(parsed) {
            ...
            _this.phierarchy = _super.prototype.getHierarchy.call(_this);
        ...
        ParsedTemplate.prototype.toJSON = function () {
            return {
                ...
                keys: this.keys.slice(),
                overriddenArgs: this.overriddenArgs.map(function (obj) { return (__assign({}, obj)); }),
                hierarchy: this.phierarchy.map(function (arr) { return __spreadArray([], arr, true); }),
         ...
         * @returns
         */
        ParsedTemplate.prototype.getHierarchy = function () {
            return this.phierarchy.map(function (arr) { return __spreadArray([], arr, true); });
        };
        /**
